...
function renderLista(list, selectedId) {
  ...
  sortByName(list.filter(p => p.id !== selectedId)).forEach(p => {
    ...
    const meta = document.createElement('div'); meta.className = 'news-meta'; meta.textContent = 'Parceiro';
    ...
    const btn = document.createElement('a'); btn.href = `?id=${p.id}`; btn.className = 'btn small'; btn.textContent = 'Ver parceiro';
...
function renderDetalhe(p) {
  ...
  const meta = document.createElement('div'); meta.className = 'news-meta'; meta.textContent = 'Parceria ativa';
  const desc = document.createElement('p'); desc.textContent = p.desc;
  const actions = document.createElement('div'); actions.className = 'news-actions';
  const back = document.createElement('a'); back.href = './index.html#contactos'; back.className = 'btn small'; back.textContent = 'Voltar a Contacte-nos';
